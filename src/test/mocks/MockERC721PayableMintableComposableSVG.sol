...
contract MockERC721PayableMintableComposableSVG is ERC721PayableMintableComposableSVG {
    ...
    constructor() ERC721PayableMintableComposableSVG(NAME, SYMBOL, PRICE, OWNER_ALLOCATION, SUPPLY_CAP, Z_INDEX) {
    }
